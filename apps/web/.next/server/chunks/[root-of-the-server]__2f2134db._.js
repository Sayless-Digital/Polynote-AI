        ...
        try {
            if (provider === 'google') {
                result = await withTempEnvVar('GOOGLE_GENERATIVE_AI_API_KEY', apiKey, async ()=>{
                    const geminiModel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$google$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["google"])(model);
                    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generateText"])({
                        model: geminiModel,
                ...
                result = await withTempEnvVar('OPENAI_API_KEY', apiKey, async ()=>{
                    const openaiModel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$openai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["openai"])(model);
                    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generateText"])({
                        model: openaiModel,
                        prompt: 'Say "Hello" if you can read this message. This is a test.'
                    });
                ...
                result = await withTempEnvVar('ANTHROPIC_API_KEY', apiKey, async ()=>{
                    const anthropicModel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ai$2d$sdk$2f$anthropic$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["anthropic"])(model);
                    return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ai$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["generateText"])({
                ...
                result = await withTempEnvVar('AI_GATEWAY_API_KEY', apiKey, async ()=>{
                    try {
                        // Dynamically import gateway to avoid isTTY issues
                        const { gateway } = await __turbopack_context__.A("[project]/node_modules/@ai-sdk/gateway/dist/index.mjs [app-route] (ecmascript, async loader)");
                        ...
                        throw new Error(`Gateway provider error: ${gatewayError instanceof Error ? gatewayError.message : 'Unknown error'}`);
                    }
                });
            } else {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2f2134db._.js.map