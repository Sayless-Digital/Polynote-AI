module.exports = [
"[project]/apps/web/.next-internal/server/app/api/analysis/tags/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
class TagsAnalysisService extends __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$analysis$2f$services$2f$BaseAnalysisService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["BaseAnalysisService"] {
    ...
    async analyze(content, context) {
        ...
        try {
            ...
            const result = this.createBaseResult(context?.noteId || 'unknown', 'completed', analysisData, undefined, processingTime);
...
"[project]/apps/web/src/app/api/analysis/tags/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$analysis$2f$services$2f$TagsAnalysisService$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
...
async function POST(request) {
    try {
        ...
        console.log('Tags Analysis Request:', {
        ...
        if (user?.id) {
            await tagsService.initialize(user.id);
        } else {
            await tagsService.initialize('default');
        }
        const result = await tagsService.analyze(content, {
            noteId: noteId || 'unknown',
            userId: user?.id
        });
        if (result.status === 'completed' && result.result) {
            console.log('Tags Analysis Completed:', {
                noteId: result.noteId,
                processingTime: result.processingTime,
                tagsCount: result.result.tags?.length || 0
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
            ...
            console.error('Tags Analysis Failed:', result.error);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: result.error || 'Tags analysis failed'
            }, {
                status: 500
            });
        }
    } catch (error) {
        console.error('Tags Analysis Error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: false,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6018f1f4._.js.map