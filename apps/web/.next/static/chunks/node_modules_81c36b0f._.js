...
"[project]/node_modules/mermaid/dist/chunks/mermaid.core/architectureDiagram-W76B3OCA.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var drawEdges = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$mermaid$2f$dist$2f$chunks$2f$mermaid$2e$core$2f$chunk$2d$AGHRB4JF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["__name"])(async function(edgesEl, cy, db) {
    ...
    await Promise.all(cy.edges().map(async (edge)=>{
        ...
        if (edge[0]._private.rscratch) {
            ...
            g.insert("path").attr("d", "M ".concat(startX, ",").concat(startY, " L ").concat(midX, ",").concat(midY, " L").concat(endX, ",").concat(endY, " ")).attr("class", "edge");
            if (sourceArrow) {
...
//# sourceMappingURL=node_modules_81c36b0f._.js.map