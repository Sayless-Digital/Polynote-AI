...
"[project]/apps/web/src/lib/file-extraction.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$parse$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/pdf-parse/index.js [app-client] (ecmascript)");
...
async function extractTextFromFile(file) {
    ...
    try {
        ...
        if (fileType === 'application/pdf' || fileName.endsWith('.pdf')) {
            ...
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$parse$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(buffer);
            return {
                text: data.text.trim(),
                type: 'pdf',
                success: true
        ...
        if (fileName.endsWith('.doc')) {
            return {
                text: "[DOC file: ".concat(file.name, "] - Content extraction not supported for .doc files. Please convert to .docx for full text extraction."),
                type: 'unsupported',
                success: false,
        ...
        if (fileType.startsWith('image/')) {
            return {
                text: "[Image file: ".concat(file.name, "] - Image content analysis not yet implemented."),
                type: 'unsupported',
                success: false,
        ...
        if (fileType.startsWith('audio/') || fileType.startsWith('video/')) {
            return {
                text: "[Media file: ".concat(file.name, "] - Audio/video transcription not yet implemented."),
                type: 'unsupported',
                success: false,
        ...
        return {
            text: "[File: ".concat(file.name, "] - File type not supported for content extraction."),
            type: 'unsupported',
            success: false,
        ...
        return {
            text: "[Error processing ".concat(file.name, "] - Could not extract content from this file."),
            type: 'unsupported',
            success: false,
...
async function extractTextFromFiles(files) {
    ...
    for (const file of files){
        ...
        if (extracted.success) {
            supportedFiles++;
            combinedText += "\n\n--- Content from ".concat(file.name, " ---\n").concat(extracted.text);
        } else {
            combinedText += "\n\n--- ".concat(file.name, " (").concat(extracted.error, ") ---\n").concat(extracted.text);
        }
    }
    return {
        extractedTexts,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$file$2d$extraction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/apps/web/src/lib/file-extraction.ts [app-client] (ecmascript)");
;
            ...
            if (attachments.length > 0) {
                ...
                for (const attachment of attachments){
                    try {
                        ...
                        const extracted = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$file$2d$extraction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractTextFromFile"])(attachment.file);
                        if (extracted.success) {
                            fileContent += "\n\n--- Content from ".concat(attachment.name, " ---\n").concat(extracted.text);
                            // Store the extracted content in the attachment object
                            attachment.content = extracted.text;
                        } else {
                            fileContent += "\n\n--- File: ".concat(attachment.name, " (").concat(extracted.error, ") ---\n").concat(extracted.text);
                            attachment.content = undefined;
                        }
                    } catch (error) {
                        console.error("Error reading file ".concat(attachment.name, ":"), error);
                        fileContent += "\n\n--- File: ".concat(attachment.name, " ---\n[Error reading file content]");
                        attachment.content = undefined;
                    }
                }
            }
...
//# sourceMappingURL=apps_web_src_22abf6aa._.js.map